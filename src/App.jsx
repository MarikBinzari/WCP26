...
const T = {
  en:{
    ...
    rulesExampleExact:"If you get the exact score in 3 group matches → 3 × 90 = 270 pts. Correct result only → 30 pts per match. (group stage)",
  ...
  ro:{
    ...
    rulesExampleExact:"Dacă prezici scorul exact în 3 meciuri din grupe → 3 × 90 = 270 pts. Rezultat corect doar → 30 pts per meci. (faza grupelor)",
  ...
  fr:{
    ...
    rulesExampleExact:"Si vous trouvez le score exact dans 3 matchs de groupes → 3 × 90 = 270 pts. Résultat correct seulement → 30 pts par match. (phase de groupes)",
...
function RulesScreen({ onBack }) {
  ...
  const exactRules = [
    ...
    { phase:"🏆 R32 · Goal Diff",        pts:exact.r32_result+exact.r32_diff_bonus,      desc:"Correct winner + goal difference (non-draw)", diff:true },
    { phase:"🏆 R32 · Exact Score",      pts:exact.r32_result+exact.r32_exact_bonus,     desc:"Exact match score" },
    { phase:"🏆 R16 · Winner",           pts:exact.r16_result,                           desc:"Correct match winner" },
    { phase:"🏆 R16 · Goal Diff",        pts:exact.r16_result+exact.r16_diff_bonus,      desc:"Correct winner + goal difference (non-draw)", diff:true },
    { phase:"🏆 R16 · Exact Score",      pts:exact.r16_result+exact.r16_exact_bonus,     desc:"Exact match score" },
    { phase:"🏆 QF · Winner",            pts:exact.qf_result,                            desc:"Correct match winner" },
    { phase:"🏆 QF · Goal Diff",         pts:exact.qf_result+exact.qf_diff_bonus,        desc:"Correct winner + goal difference (non-draw)", diff:true },
    { phase:"🏆 QF · Exact Score",       pts:exact.qf_result+exact.qf_exact_bonus,       desc:"Exact match score" },
    { phase:"🏆 SF · Winner",            pts:exact.sf_result,                            desc:"Correct match winner" },
    { phase:"🏆 SF · Goal Diff",         pts:exact.sf_result+exact.sf_diff_bonus,        desc:"Correct winner + goal difference (non-draw)", diff:true },
    { phase:"🏆 SF · Exact Score",       pts:exact.sf_result+exact.sf_exact_bonus,       desc:"Exact match score" },
    { phase:"🏆 Final · Winner",         pts:exact.final_result,                         desc:"Tournament winner" },
    { phase:"🏆 Final · Goal Diff",      pts:exact.final_result+exact.final_diff_bonus,  desc:"Correct winner + goal difference (non-draw)", diff:true },
    { phase:"🏆 Final · Exact Score",    pts:exact.final_result+exact.final_exact_bonus, desc:"Exact match score" },
  ];
